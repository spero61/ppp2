// The version from 9.4.3 Keep details private
...
class Date {
   ...
   public:
    ...
    int month() const { return m; }  // operator overloading of << requires a const-by-reference representation.
...
int main() {
    try {
        ...
        // today.m = 100;  // compile-error: 'int Date::m' is private within this context
