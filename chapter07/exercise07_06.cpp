...
// Have the calculator print out some instructions for how to use the calculator
// if the user presses the H key (both upper- and lowercase).
...
void calculate()
{
    cout << "\n~~ Welcome to our simple calculator ~~\n"
         << "Press h or H followed by enter to print help messages\n";
    while (true)
        try
        {
            cout << prompt;
