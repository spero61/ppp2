...
// and it does not incorporate the grammar changes outlined in §7.8. Fix that grammar.
// Also add whatever you feel is needed to that comment as the first comment of the calculator program and its overall comment.
// Bjarne, Stroustrup. Programming (p. 253). Pearson Education. Kindle Edition.

// I have combined previous works ! factorial operator as well as % modulo into this exercise.
// And I have just realized that I did not provide assignment operator '=' properly.
// Rather I just dealt with let and const, declaration again and again.
// Recall that Dr. Stroustrup's advice on page 224
// "It is unwise to make major structural changes to gain a minor advantage"

// adding assignment operator '=' to the program rather than using declaration again provides us a minor advatage,
