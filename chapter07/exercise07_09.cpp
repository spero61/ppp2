// 9. Suggest three improvements (not mentioned in this chapter)
// to the calculator. Implement one of them

// Suggestion
// 1) memory function. save the result to the memory. Can be loaded as well.
// 2) introduce logarithmic function (base : e)
// 3) operations of linear algebra such as declaration of matrix, scalar multiplication
...
void print_help_messages() {
    cout << "Please enter expressions using floating-point numbers.\n"
         ...
         << "there are functions (pow(n, m), sqrt(n), and log(n) of base e\n"
