...
int main() {
    try {
        ...
        print_array(cout, from_hundred_20, 20);
        ...
        vector<int> v_nums = {100, 101, 102, 103, 104, 105, 106, 107, 108, 109};
        print_vector(cout, v_nums);  // equals to print_array10(cout, from_hundred_10);

        v_nums.push_back(110);
        print_vector(cout, v_nums);  // equals to print_array(cout, from_hundred_11, 11);

        int next_num{v_nums[v_nums.size() - 1]};
        for (int i = v_nums.size(); i < 20; ++i) {
            v_nums.push_back(++next_num);
        }
        print_vector(cout, v_nums);  // equals to print_array(cout, from_hundred_20, 20);
