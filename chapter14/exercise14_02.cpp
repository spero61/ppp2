...
// A: Compile error occurrs as below:
//    C++ function (declared implicitly) cannot be referenced -- it is a deleted function
//    Because Shape class declared the copy constructor and the copy assignment deleted.
...
int main() {
    try {
        ...
        Smiley merry = happy;  // compile error!
